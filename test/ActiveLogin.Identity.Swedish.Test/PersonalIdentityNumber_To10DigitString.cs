...
namespace ActiveLogin.Identity.Swedish.Test
{
    ...
    /// </remarks>
    public class PersonalIdentityNumber_To10DigitString
    {
        [Theory]
        ...
        {
            var personalIdentityNumber = new PersonalIdentityNumber(2000, 1, 1, 238, 4);
        ...
        {
            var personalIdentityNumber = new PersonalIdentityNumber(2017, 1, 22, 238, 0);
        ...
        public void To10DigitString_WhenParseYearIs200YearsAfterPersonWasBorn_ThrowsArgumentException(string str, int birthYear)
        {
            ...
            var pin = PersonalIdentityNumber.Parse(str);
