...
type SwedishCoordinationNumberCSharp private(num : SwedishCoordinationNumber) =
    ...
    /// </summary>
    member __.CoordinationDay = identityNumber.CoordinationDay.Value

    /// <summary>
    /// The day for date of birth
    /// </summary>
    member __.RealDay = identityNumber.RealDay
    ...
    override __.Equals(b) =
        match b with
        | :? SwedishCoordinationNumberCSharp as num -> identityNumber = num.IdentityNumber
        | _ -> false
